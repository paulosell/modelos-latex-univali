...
% 
% 2023/26/09 versão 1.01
% 
% Modelo de dissertação para a Universidade do Vale do Itajai
% 
% Adaptação do documento abnTeX2: Modelo de Trabalho Acadêmico
% para ficar de acordo com o "Livro digital para eleboração de trabalhos academios" fornecido pela Biblioteca da UNIVALI
% WORK IN PROGRESS
% 
%-----------------------------------------------------------------%
\documentclass[
